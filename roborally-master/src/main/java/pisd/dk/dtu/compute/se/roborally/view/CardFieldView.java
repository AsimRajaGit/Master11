...
import pisd.dk.dtu.compute.se.roborally.model.CommandCard;
import pisd.dk.dtu.compute.se.roborally.model.CommandCardField;
...
/**
 * This class defines how the card fields looks in the view (GUI).
 *
...
public class CardFieldView extends GridPane implements ViewObserver {
    ...
    /**
     * The following classes handles the events that occurs when a card is dragged and used. It also checks
     * that the card is used in the correct phase of the players turn.
     */
